...
import gmaps_query_data_file as gmaps_data
...
current_destinations = add_districts([outer_sunset, noe_valley, pacific_heights, outer_richmond, mission_district, oakland, berkeley])
...
key={}&\
departure_time=now""".\
format(current_origins, current_destinations, travel_mode, gmaps_data.api_key))
